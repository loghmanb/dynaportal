...
class RadiosTest(BaseTestCase):
    ...
    def test_simple_radios_with_legond(self):
        ...
        self.assertEqual(
            rendered,
            '<div class="govuk-form-group ">\n    \n<fieldset class="govuk-fieldset">\n  <legend class="govuk-fieldset__legend govuk-fieldset__legend--">\n    <h1 class="govuk-label-wrapper">\n  <label class="govuk-label govuk-label--l" for="live-id">\n    Where do you live?\n  </label>\n</h1>\n  </legend>\n  \n  \n  \n  \n<div class="govuk-radios" data-module="govuk-radios">\n    <div class="govuk-radios__item">\n        <input class="govuk-radios__input" id="live-id-england" name="live-england" type="radio"\n            value="england">\n        <label class="govuk-label govuk-radios__label" for="live-id-england">\n            England\n        </label>\n        \n    </div>\n    <div class="govuk-radios__item">\n        <input class="govuk-radios__input" id="live-id-scotland" name="live-scotland" type="radio"\n            value="scotland">\n        <label class="govuk-label govuk-radios__label" for="live-id-scotland">\n            Scotland\n        </label>\n        \n    </div>\n    <div class="govuk-radios__item">\n        <input class="govuk-radios__input" id="live-id-wales" name="live-wales" type="radio"\n            value="wales">\n        <label class="govuk-label govuk-radios__label" for="live-id-wales">\n            Wales\n        </label>\n        \n    </div>\n    <div class="govuk-radios__item">\n        <input class="govuk-radios__input" id="live-id-northen-ireland" name="live-northen-ireland" type="radio"\n            value="northen-ireland">\n        <label class="govuk-label govuk-radios__label" for="live-id-northen-ireland">\n            Northern Ireland\n        </label>\n        \n    </div>\n    \n</div>\n\n  \n</fieldset>\n\n</div>\n',
        )
